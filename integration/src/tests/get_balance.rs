...
use core_rpc_types::{
    AssetInfo, AssetType, GetBalancePayload, JsonItem, Mode, Ownership, SudtIssuePayload, To,
    ToInfo,
};
...
fn test_get_balance_of_identity_cheque() {
    // prepare
...
inventory::submit!(IntegrationTest {
    name: "test_get_balance_of_identity_cheque",
    test_fn: test_get_balance_of_identity_cheque
});
