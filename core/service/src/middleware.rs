...
const DRY_RUN_TRANSACTION: &str = "dey_run_transaction";
const CALCULATE_DAO_MAXIMUM_WITHDRAWN: &str = "calculate_dao_maximum_withdraw";
...
const SET_NETWORK_NATIVE: &str = "set_network_native";
...
const GET_RAW_TX_INFO: &str = "get_raw_tx_info";
...
lazy_static::lazy_static! {
    static ref CKB_RPC_REQ_SET: HashSet<String> = {
        ...
        set.insert(CALCULATE_DAO_MAXIMUM_WITHDRAWN.to_string());
        ...
        set.insert(SET_NETWORK_NATIVE.to_string());
        ...
        set.insert(GET_RAW_TX_INFO.to_string());
