...
mod tests {
            ...
            mod $tests_name {
                ...
                fn deserialize_with_redundant_leading_zeros() {
                    ...
                    for s in cases {
                        ...
                        assert!(err.to_string().contains("with redundant leading zeros"),);
                    }
                }
    ...
    test_json_uint!(uint16, Uint16, u16);
