...
impl molecule::prelude::Entity for SmtUpdateItem {
    ...
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().key(self.key()).values(self.values())
    }
}
#[derive(Clone, Copy)]
...
impl<'r> SmtUpdateItemReader<'r> {
    ...
    pub fn values(&self) -> ByteReader<'r> {
        ByteReader::new_unchecked(&self.as_slice()[32..33])
    }
}
...
impl SmtUpdateItemBuilder {
    ...
    pub fn values(mut self, v: Byte) -> Self {
        self.values = v;
        self
    }
}
