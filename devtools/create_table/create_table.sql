...
CREATE INDEX "index_script_table_script_hash_160" ON "mercury_script" USING btree (
  "script_hash_160"
);
...
CREATE INDEX "index_indexer_cell_table_tx_hash" ON "mercury_indexer_cell" USING hash (
